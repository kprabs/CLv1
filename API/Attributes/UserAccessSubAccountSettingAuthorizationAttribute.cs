...
//    public class UserAccessSubAccountSettingAuthorizationAttribute : Attribute, IAuthorizationFilter
//    {
//        public string? _settingName { get; set; }
//        public string? _subAccountNKey { get; set; }
//        public UserAccessSubAccountSettingAuthorizationAttribute(string settingName)
//        {
...
//                    if (!authorizationService.CanCurrentUserAccessSubAccountFromSetting(_settingName ?? String.Empty, _subAccountNKey))
//                    {
