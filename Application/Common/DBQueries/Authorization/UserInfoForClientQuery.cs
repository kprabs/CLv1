namespace CoreLib.Application.Common.DBQueries
{
    ...
    {
        public const string UserInfoForClientQuery = @"select
		...
		where lsu.SourceLogInSystemUserName = '@UserName' and spgs.SystemId=@SystemId and csic.ClassifiedAreaSegmentNKey = '@ClientId' and lsusai.SystemId=@SystemId
